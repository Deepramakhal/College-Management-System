		...
		try(Connection con=DbConnection.getConnection())
		{
			if(role.equals("HOD")||role.equals("PRINCIPAL"))
			{
				...
				if(rs.next())
				{
					...
					{
						Admin admin = new Admin(rs.getString("id"),rs.getString("name"),rs.getString("email"),rs.getString("phone"),rs.getString("admin_type"),rs.getString("password"),rs.getString("profile_image"),rs.getString("address"));
