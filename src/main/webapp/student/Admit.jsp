	...
	try(Connection con = DbConnection.getConnection()){
		...
		if(rs.next()){
			if("false".equalsIgnoreCase(rs.getString("isAdmitGenerated"))){
				%>
					<h1>Your exam form is not verified by HOD. Please contact the HOD for further assistance </h1>
				<%
			}
			else {
				%>
				<div class="admit-card">
			        ...
			        <div class="student-details">
			            ...
			            <div class="student-info">
			                ...
			                <p><strong>Course:</strong><%=(String)request.getParameter("cName") %></p>
			...
			%>
				<h1>You have not submitted your exam form</h1><%
		}
	}
%>
