       ...
       <div id="sec-8">
        <div class="laboratories-container">
          ...
          <ul class="laboratories-list">
            ...
            <li>ISpecial Research laboratories named (AI+ML) Lab, ANTENNA Lab, INNOVATION Lab, AR-VR Lab, Computer vision lab, Data Science Lab.</li>
        ...
        <div class="D-library-container">
          ...
          <ul class="D-library-list">
            ...
            <li>Subscription to Internationally renowned Digital Libraries like IEEE, JGATE, DELNET et</li>
          </ul>
        </div>
       </div>
       <div id="sec-9">
        ...
        <div class="studentChapter-container">
          ...
          <ul class="studentChapter-list">
            ...
            <li>IEEE Student branch,ASME TNVI Student Chapter & SAE-TNVI Colligate Club.</li>
